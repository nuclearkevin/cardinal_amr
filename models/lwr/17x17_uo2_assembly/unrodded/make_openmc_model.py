...
#--------------------------------------------------------------------------------------------------------------------------#
# This is based on the C5G7 reactor physics benchmark problem as described in:                                             #
...
ref_assembly_cells = [
  ...
  [wat_u, wat_u, wat_u, tub_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, tub_u, wat_u, wat_u, wat_u], # 4
  [wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u], # 5
  [wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u], # 6
  ...
  [wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u, wat_u, wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u], # 9
  ...
  [wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u], # 12
  [wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u], # 13
  [wat_u, wat_u, wat_u, tub_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, wat_u, tub_u, wat_u, wat_u, wat_u], # 14
  [wat_u, wat_u, wat_u, wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u, tub_u, wat_u, wat_u, wat_u, wat_u, wat_u], # 15
...
#--------------------------------------------------------------------------------------------------------------------------#
# Setup the model.
c5g7_model = openmc.Model(geometry = openmc.Geometry(openmc.Universe(cells = all_cells)), materials = openmc.Materials([uo2, h2o, fiss, zr, al]))
